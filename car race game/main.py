...
CARS_COLORS = ["hhhh/cars1.gif", "hhhh/cars2.gif", "hhhh/cars3.gif", "hhhh/cars4.gif", "hhhh/cars5.gif"]

screen = Screen()
screen.setup(width=850, height=480)
screen.bgpic("hhhh/bg-road1.gif")
screen.addshape("hhhh/cars5.gif")
screen.addshape("hhhh/cars4.gif")
screen.addshape("hhhh/cars3.gif")
screen.addshape("hhhh/cars2.gif")
screen.addshape("hhhh/cars1.gif")
